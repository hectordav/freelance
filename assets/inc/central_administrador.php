        ...
        <div class="">
          <div class="row top_tiles">
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats">
                ...
                <div class="count"><?=$contar_usuario?></div>
                <h3>Usuarios Registrados</h3>
                <a href="<?=$this->config->base_url()?>usuario"><p>Ir a Usuarios</p></a>
              </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats">
                ...
                <div class="count"><?=$contar_retiro_dinero?></div>
                <h3>Solicitud de Retiro</h3>
                  <a href="<?=$this->config->base_url()?>retiro_dinero"><p>Ir a Retiro de Dinero</p></a>
              </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats">
                ...
                <div class="count"><?=$contar_proyectos_todos?></div>
                <h3>Nuevos proyectos</h3>
                 <a href="<?=$this->config->base_url()?>proyecto"><p>Ver Todos Proyectos</p></a>
              </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12">
              <div class="tile-stats">
                ...
                <?php if ($sumar_dinero_todo): ?>
                  <?php foreach ($sumar_dinero_todo->result() as $data): ?>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>Ultimos Proyectos Publicados </h2>
                  ...
                  <div class="row" style="border-bottom: 1px solid #E0E0E0; padding-bottom: 5px; margin-bottom: 5px;">
                    <div class="col-md-12" style="overflow:hidden;">
                      ...
                      <tbody>
                        ...
                        <?php foreach ($ultimos_proyectos->result() as $data): ?>
