<div class="modal fade "id="mnuevousuario">
		        <div class="modal-dialog modal-lg">
		          <div class="modal-content">
					...
					<?php if ($login): ?>
						<center><a href="<?= $login ?>"><img src="<?= $this->config->base_url();?>/images/registrate_fbc.png"width="200" height="50"></a></center>
					<?php endif ?>
					...
					<div class="container">
						<div class="row">
	<form action="<?php echo $this->config->base_url();?>usuario/guardar_usuario" method="POST" accept-charset="utf-8">
	<br>
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<div class="col-md-4 col-sm-4 col-xs-4">
			  ...
			  <div class="before col-md-12 text-center"><img src='images/loader.gif' /></div>
						<option data-tokens="">Seleccione Ciudad</option>
	...
	<div id="siguele"  style='display:none;'>
	<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="col-md-1 col-sm-1 col-xs-1">
